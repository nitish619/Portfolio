...
import website from "@/assets/website-link.jpg";
          ...
          {projects
            ...
            .map((project, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black to-transparent opacity-20 group-hover:opacity-60 flex items-center justify-center text-center p-4 md:p-8 transform translate-y-full group-hover:translate-y-0 transition-all duration-700 ease-in-out">
